...
// Request contains the parameters for the User Agent Parser API.
//
// Parameters:
//   - ua (required): string - The user agent string to parse
type Request struct {
	Ua string `json:"ua"` // Required
}
...
// ResponseData contains the data returned by the User Agent Parser API.
