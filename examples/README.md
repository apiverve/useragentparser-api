# User Agent Parser API - Examples

This folder contains example code for using the User Agent Parser API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/useragentparser',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/useragentparser");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/useragentparser](https://docs.apiverve.com/ref/useragentparser)
