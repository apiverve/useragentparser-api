...
namespace APIVerve.API.UserAgentParser
{
    ...
    /// <summary>
    /// Client for the UserAgentParser API
    /// </summary>
...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/useragentparser";
        ...
        {
            { "ua", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public UserAgentParserAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UserAgentParserAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UserAgentParserAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(UserAgentParserQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(UserAgentParserQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(UserAgentParserQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(UserAgentParserQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(UserAgentParserQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(UserAgentParserQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
