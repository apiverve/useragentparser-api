...
```gradle
dependencies {
    implementation 'com.github.apiverve:useragentparser-api:1.1.12'
}
```
...
```java
import com.apiverve.useragentparser.UserAgentParserAPIClient;
import com.apiverve.useragentparser.APIResponse;
import com.apiverve.useragentparser.APIException;

// Initialize the client
UserAgentParserAPIClient client = new UserAgentParserAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/useragentparser](https://docs.apiverve.com/ref/useragentparser)
...
- **Documentation:** [https://docs.apiverve.com/ref/useragentparser](https://docs.apiverve.com/ref/useragentparser)
- **Issues:** [GitHub Issues](https://github.com/apiverve/useragentparser-api/issues)
